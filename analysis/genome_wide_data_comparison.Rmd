...
plot(reads_bri_mean ~ reads_abs_dif_mean, main= "Absolute value of mean read counts", xlab="Bri mean reads", ylab = "Absolute value of the difference between bri and git reads")
...
ERCC_67 <- rbind(reads_subset["ERCC-00014",], reads_bri2["ERCC-00067",])
