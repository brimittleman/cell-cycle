...
####Trim UMI  
Create the trim.sh script using the code from github in the code folder. Try to run this on all of the files:  
```
...
To do from meeting with Peter 1/17:  
 - move programs to bin in software - (ln -s /project/gilad/brimittleman/bioawk/bioawk 
)  
