...
I created the count-reads-per-gene.sh and a wrap script for it. I will run it first on the bam-processed files.
```
wrap_CRPG.sh *bam
```

To run this I need to use the create exon script in R to make the necssesary file for the featurecounts tool to use.  

```
Rscript create-exons.R  genome/ERCC92.gtf > genome/exons.saf
```
