...
molecules_and_mean_order <- arrange(molecules_and_mean, desc(molecules_mean, drop=FALSE))
...
mean_expression <- plot(log(molecules_and_mean_order$molecules_mean) , pch=shap_vec_onlySC, cex=2, col=col_vec_onlySC, main = "Log scale mean expression of molecules per gene", ylab=" Log scale molecule count", xlab = "Genes ordered by expression")
...
#sort by IQR
molecules_and_IQR_order <- arrange(molecule_w.IQR, desc(molecule_IQR, drop=FALSE))


IQR_plot <- plot((molecules_and_IQR_order$molecule_IQR) , pch=shap_vec_onlySC, cex=2, col=col_vec_onlySC, main = "IQR of expression of molecules per gene", ylab=" IQR in Molecule count", xlab = "Genes ordered by IQR")
legend("topright", c("Single cell only", "All genes"), pch=c(16,16), col=c("coral4", "gray70") )
```
